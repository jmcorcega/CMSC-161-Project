...
function setDialogMessage(title, content, subtitle) {
...
function setDialogButtonText(positive, negative, neutral) {
...
function setDialogButtons(positiveEvent, negativeEvent, neutralEvent) {
...
function setPauseDialogButtons(resume, restart, exit) {
    clearPauseEvents();
...
function setEndLevelDialogButtons(restart, exit) {
...
function setEndLevelMessage(message, img, isRestart, isNewRecord) {
