...
export default class DialogController {
    ...
    setEndLevelMessage(message, img, isRestart, isNewRecord) {
        document.getElementById('dialog-end-game-subtitle').innerHTML = message;
        ...
        document.getElementById('dialog-end-game-image').style.display = (!isNewRecord) ? '' : 'none';
        document.getElementById('dialog-end-game-new').style.display = (isNewRecord) ? '' : 'none';
    }
